...
<h1 style="font-size:45px;text-align:center;color:#FF0000">Community Connect</h1>
    ...
    <form class="form" method="post" name="search">
        <h2 style="text-align:center;">Schools</h2> <!-- Added Restaurants heading -->
...
if(isset($_POST['city'])){
    ...
    $restaurantApiUrl = "https://api.foursquare.com/v3/places/search?&categories=12057&near=".$city."&limit=10&v=20190425";
